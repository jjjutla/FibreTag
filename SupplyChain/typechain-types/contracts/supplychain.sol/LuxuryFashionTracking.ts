...
export interface LuxuryFashionTrackingInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface LuxuryFashionTracking extends BaseContract {
  connect(runner?: ContractRunner | null): LuxuryFashionTracking;
  waitForDeployment(): Promise<this>;

  interface: LuxuryFashionTrackingInterface;
